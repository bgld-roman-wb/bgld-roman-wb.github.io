...
export const ui = {
	de: {
		...
		'about.downloadHint': 'Vollständiges Manuskript mit Geschichte, Struktur, Lexik und Schreibung',
		'about.staffToggle': 'Mitarbeiter*innen und wissenschaftliche Betreuer anzeigen',
	...
	en: {
		...
		'about.downloadHint': 'Full manuscript with history, structure, lexicon, and spelling',
		'about.staffToggle': 'Show staff and mentors',
