...
export const ui = {
	de: {
		...
		'grammar.note': 'Weitere Informationen zur Grammatik des Roman.',
		'grammar.link': 'Grammatik',
		'grammar.pageTitle': 'Grammatik',
		'grammar.comingSoon': 'Grammatik wird geliefert!',
	...
	en: {
		...
		'grammar.note': 'Further information on the grammar of Roman.',
		'grammar.link': 'Grammar',
		'grammar.pageTitle': 'Grammar',
		'grammar.comingSoon': 'Grammar will be delivered!',
