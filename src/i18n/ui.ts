...
export const ui = {
	de: {
		...
		'home.blurb': 'Roman ist der Romani-Dialekt der Burgenland-Roma, seit den 1990er-Jahren verschriftlicht. Dieses Wörterbuch macht den dokumentierten Wortschatz frei zugänglich — mit allen Beugungsformen, Wortfamilien und Angaben zur Herkunft jedes Wortes.',
		...
		'impressum.copyright': '© [Platzhalter — wird noch bestätigt]',
		'impressum.content': 'Inhalt: Dieter Halwachs',
		'impressum.technik': 'Technik: Valentin Edelsbrunner',
	...
	en: {
		...
		'home.blurb': 'Roman is the Romani dialect of the Burgenland Roma, written down since the 1990s. This dictionary makes the documented vocabulary freely accessible — with full inflection tables, word families, and the origin of every word.',
		...
		'impressum.copyright': '© [Placeholder — to be confirmed]',
		'impressum.content': 'Content: Dieter Halwachs',
		'impressum.technik': 'Technical: Valentin Edelsbrunner',
