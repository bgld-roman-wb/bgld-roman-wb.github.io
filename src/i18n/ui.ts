...
export const ui = {
	de: {
		...
		'search.resultsOne': 'Treffer',
		'search.resultsMany': 'Treffer',
		...
		'grammar.endingsHint.verb': 'Perfektivmarker; 3. Pers. Pl. Perfektiv',
	...
	en: {
		...
		'grammar.endingsHint.verb': 'perfective marker; 3rd pl. perfective',
